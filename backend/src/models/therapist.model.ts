...
const therapistAvailabilitySlotSchema = new Schema(
	{
...
export type TherapistProfileDocument = InferSchemaType<typeof therapistProfileSchema> & {
	_id: Types.ObjectId;
};

export const TherapistProfileModel = model('TherapistProfile', therapistProfileSchema);

export default TherapistProfileModel;
