...
import { PresetAssessmentEntry } from './components/patient/PresetAssessmentEntry'
...
import FreeScreening from './pages/provider/Patients/Tabs/FreeScreening';
import PatientCommunicationPreference from './pages/patient/PatientCommunicationPreference';
import PatientBookingPrompt from './pages/patient/PatientBookingSession';
import BookFirstSessionPage from './pages/patient/PatientBookingSession';
import ClinicalAssessmentsPage from './pages/patient/ClinicalAssessmentsPage';
      ...
      <SocketProvider>
        ...
        <Suspense fallback={<GlobalFallbackLoader />}>
          ...
          <Routes>
            ...
            {/* <Route path="/free-screening" element={<FreeScreening />} /> */}
            <Route
  path="/free-screening"
  element={<ClinicalAssessmentsPage />}
/>
            <Route path="/patient/onboarding/preferences" element={<PatientCommunicationPreference />} />
<Route path="/patient/onboarding/booking-prompt" element={<BookFirstSessionPage />} />
