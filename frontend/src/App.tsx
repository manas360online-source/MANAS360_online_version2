...
function RoleAwarePrescriptionsTab() {
  const { user } = useAuth();
  const role = String(user?.role || '').toLowerCase();

  if (role === 'psychiatrist') {
    return <PsychiatristPrescriptionsPage />;
  }
          ...
          <Routes>
            ...
            >
              ...
              <Route path="patient/:patientId" element={<PatientChartLayout />}>
                ...
                <Route path="prescriptions" element={<RoleAwarePrescriptionsTab />} />
            ...
            <Route
              path="/admin/data-privacy-hub"
              element={
                <PlatformAdminRoute>
                  <AdminDataPrivacyHubPage />
                </PlatformAdminRoute>
              }
            />
